                                        ...
                                        <?php foreach ($data['posts'] as $post):?>
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-evenly">
                                                    ...
                                                    <!--form action="</?php echo URLROOT ?>/posts/delete_posts/<?php echo $post->id; ?>" method="POST">
                                                    ...
                                                    <form id="messageForm_<?php echo $post->id; ?>" action="app/views/posts/send.php" method="POST">
                                                            <input type="hidden" name="id" value="<?php echo $post->id; ?>">
                                                            <input type="hidden" name="title" value="<?php echo $post->title; ?>">  <!-- Add title -->
                                                            <input type="hidden" name="body" value="<?php echo $post->body; ?>">  <!-- Add body -->
                                                            <button type="button" class="btn btn-warning btn-sm rounded-pill" onclick="confirmSendMessage(<?php echo $post->id; ?>)">
